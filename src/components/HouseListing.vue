...
<div class="shadow rounded-top house-border">
  ...
  <div class="bg-light p-3">
        <p class="fs-5">{{ 'Price: $' + houseProp.price.toLocaleString() }}   </p>
        <p class="fs-5 mb-0"> Built: {{ houseProp.year }}</p>
  <hr>
<div class="d-flex justify-content-between align-items-center mb-2">
      <p class="fs-5 mb-0">Beds: {{ houseProp.bedrooms }} Bathrooms: {{ houseProp.bathrooms }} Floors: {{ houseProp.levels }}</p>
